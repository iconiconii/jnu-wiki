    ...
    switch (key) {
      case 'blue':
        return {
          ...
          arrow:
            'bg-blue-200 text-blue-700 group-hover:bg-blue-300 dark:bg-blue-900/40 dark:text-blue-200 dark:group-hover:bg-blue-800',
          accent: 'blue',
        }
      case 'purple':
        return {
          ...
          arrow:
            'bg-purple-200 text-purple-700 group-hover:bg-purple-300 dark:bg-purple-900/40 dark:text-purple-200 dark:group-hover:bg-purple-800',
          accent: 'purple',
        }
      case 'amber':
        return {
          ...
          arrow:
            'bg-amber-200 text-amber-700 group-hover:bg-amber-300 dark:bg-amber-900/40 dark:text-amber-200 dark:group-hover:bg-amber-800',
          accent: 'amber',
        }
      case 'indigo':
        return {
          ...
          arrow:
            'bg-indigo-200 text-indigo-700 group-hover:bg-indigo-300 dark:bg-indigo-900/40 dark:text-indigo-200 dark:group-hover:bg-indigo-800',
          accent: 'indigo',
        }
      case 'teal':
        return {
          ...
          arrow:
            'bg-teal-200 text-teal-700 group-hover:bg-teal-300 dark:bg-teal-900/40 dark:text-teal-200 dark:group-hover:bg-teal-800',
          accent: 'teal',
        }
      case 'cyan':
        return {
          ...
          badge:
            'bg-cyan-100 text-cyan-800 border-cyan-200 dark:bg-cyan-900/40 dark:text-cyan-100 dark:border-cyan-800',
          arrow:
            'bg-cyan-200 text-cyan-700 group-hover:bg-cyan-300 dark:bg-cyan-900/40 dark:text-cyan-200 dark:group-hover:bg-cyan-800',
          accent: 'cyan',
        }
      case 'emerald':
        return {
          ...
          arrow:
            'bg-emerald-200 text-emerald-700 group-hover:bg-emerald-300 dark:bg-emerald-900/40 dark:text-emerald-200 dark:group-hover:bg-emerald-800',
          accent: 'emerald',
        }
      case 'rose':
        return {
          ...
          badge:
            'bg-rose-100 text-rose-800 border-rose-200 dark:bg-rose-900/40 dark:text-rose-100 dark:border-rose-800',
          arrow:
            'bg-rose-200 text-rose-700 group-hover:bg-rose-300 dark:bg-rose-900/40 dark:text-rose-200 dark:group-hover:bg-rose-800',
          accent: 'rose',
        }
      case 'orange':
        return {
          ...
          badge:
            'bg-orange-100 text-orange-800 border-orange-200 dark:bg-orange-900/40 dark:text-orange-100 dark:border-orange-800',
          arrow:
            'bg-orange-200 text-orange-700 group-hover:bg-orange-300 dark:bg-orange-900/40 dark:text-orange-200 dark:group-hover:bg-orange-800',
          accent: 'orange',
        }
      case 'green':
      default:
        return {
          ...
          arrow:
            'bg-green-200 text-green-700 group-hover:bg-green-300 dark:bg-green-900/40 dark:text-green-200 dark:group-hover:bg-green-800',
          accent: 'green',
        }
    }
  }
    ...
    >
      <CardHeader className="pb-4 p-6 relative">
        ...
        <div className="absolute top-0 right-0 w-32 h-32 opacity-5 pointer-events-none">
          <div className={cn('text-8xl', styles.icon)}>{category.icon}</div>
        </div>
        ...
        <div className="flex items-start justify-between relative">
          <div className="flex items-start space-x-3 sm:space-x-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <CardDescription
                className={cn('text-sm line-clamp-2 leading-relaxed', styles.description)}
              >
        ...
        <div className="space-y-3 h-full flex flex-col">
          ...
          {category.services && category.services.length > 0 && (
            <div className="space-y-2">
              <div
                className={cn('text-xs font-semibold uppercase tracking-wide', styles.description)}
              >
                热门服务
              </div>
              <div className="flex flex-wrap gap-1.5">
                ...
                {category.services.length > 3 && (
                  <Badge
                    variant="outline"
                    className={cn('text-xs px-2 py-1 rounded-lg opacity-75', styles.badge)}
                  >
                    +{category.services.length - 3}
                  </Badge>
                )}
          ...
          {(!category.services || category.services.length === 0) &&
            (!category.children || category.children.length === 0) && (
              <div
                className={cn(
                  'text-center py-4 text-sm italic opacity-60 flex-grow flex items-center justify-center',
                  styles.description
                )}
              >
